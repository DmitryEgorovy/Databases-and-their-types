...
1.1. К таким задачам больше подойдет реляционая база данных например MySQL или PostgreSQL так как данные скорей всего будут иметь зачастую одинаковый формат.  
